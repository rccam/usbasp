/*
 * uart.c - part of USBaspTTY mod (usbasp+)
 *
 * Autor..........: Eric (emklausATgmail.com)
 * Description....: Provides functions for UART communication pasthrought USBasp with use of additional PC host component
 * Licence........: GNU GPL v3 (see LICENSE.txt)
